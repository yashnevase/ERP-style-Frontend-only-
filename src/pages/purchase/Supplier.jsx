...
const Supplier = () => {
  ...
  const handleInputChange = (e, field) => {
    ...
    setPoDetails((prevDetails) => ({ ...prevDetails, [field]: value }));
  };
      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="bg-white p-6 rounded shadow-lg relative max-w-full max-h-full"> {/* the container */}
            ...
            <select 
              className="select select-bordered w-full max-w-xs bg-white text-gray-500 my-px"
              value={poDetails.UnitList}
              onChange={(e) => handleInputChange(e, 'UnitList')}>
              <option disabled value="">Please Select Unit</option>
            ...
            <input
              ...
              onChange={(e) => handleInputChange(e, 'poNo')} // Pass the e and field as arguments
              placeholder="PO No"
